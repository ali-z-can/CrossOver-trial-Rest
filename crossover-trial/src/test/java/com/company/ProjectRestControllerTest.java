...
public class ProjectRestControllerTest {
    ...
    @Autowired
    private JacksonTester<PatchRequest> jsonPatchRequest;
    ...
    public void cantPostUnderConflict() throws IOException, Exception {
        ...
        given(projectService.createProject(any(Project.class))).willThrow(new AllreadyExistsException(1234));
    ...
    public void canPatch() throws Exception{
        ...
        given(projectService.updateProject(eq(1),any(PatchRequest.class))).willReturn(p);
    ...
    public void cantPatchIfNonExistingSystem() throws Exception{
        ...
        given(projectService.updateProject(eq(1L),any(PatchRequest.class))).willThrow(new NotFoundException(SdlcSystem.class, 1L));
    ...
    public void cantTestIfConflictExists() throws Exception{
        ...
        given(projectService.updateProject(eq(1L),any(PatchRequest.class))).willThrow(new AllreadyExistsException(1L));
